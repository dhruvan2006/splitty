...
public class DebtTest {
    ...
    void getterPersonsFrom(){
        ...
        participants[0] = new Participant("Eduardas", "Eduardas", "EA");
        participants[1] = new Participant("Eduardas", "Eduardas", "EA");
        participants[2] = new Participant("Eduardas", "Eduardas", "EA");
